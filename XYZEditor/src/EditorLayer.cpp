...
namespace XYZ {
	...
	{	
		...
		particleComponentCPU.System->GetEmitData()->m_BurstEmitter.m_Bursts.emplace_back(250, 1.0f);
		particleComponentCPU.System->GetEmitData()->m_BurstEmitter.m_Bursts.emplace_back(250, 4.0f);
