...
namespace XYZ {
	...
	void EditorLayer::OnAttach()
	{
		...
		m_ChildRenderable->Layer = SortingLayer::Get().GetOrderValue("Default");
		m_ChildRenderable->IsVisible = true;
		...
		m_ChildRenderable2->Layer = SortingLayer::Get().GetOrderValue("Default");
		m_ChildRenderable2->IsVisible = true;
