...
namespace XYZ {
	...
	private:
		...
		VkPipelineVertexInputStateCreateInfo			    createVertexInputInfo(std::vector<VkVertexInputBindingDescription>& bindingDescriptions, std::vector<VkVertexInputAttributeDescription>& vertexInputAttributes) const;
