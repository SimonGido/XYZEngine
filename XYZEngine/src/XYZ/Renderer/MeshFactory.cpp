...
namespace XYZ {
	...
	Ref<Mesh> MeshFactory::CreateBox(const glm::vec3& size, const BufferLayout& layout)
	{
		glm::vec3 positions[8] = {
			{ -size.x / 2.0f, -size.y / 2.0f,  size.z / 2.0f }, // Front Down Left
			{ size.x / 2.0f, -size.y / 2.0f,  size.z / 2.0f },  // Front Down Right 
			{ size.x / 2.0f,  size.y / 2.0f,  size.z / 2.0f },  // Front Up	  Right
			{ -size.x / 2.0f,  size.y / 2.0f,  size.z / 2.0f },	// Front Up	  Left
			
			{ -size.x / 2.0f, -size.y / 2.0f, -size.z / 2.0f },	// Back  Down Left
			{ size.x / 2.0f, -size.y / 2.0f, -size.z / 2.0f },	// Back  Down Right
			{ size.x / 2.0f,  size.y / 2.0f, -size.z / 2.0f },	// Back  Up	  Right
			{ -size.x / 2.0f,  size.y / 2.0f, -size.z / 2.0f }	// Back  Up	  Left
		};
