...
namespace XYZ {
	...
	public:
		...
		*/
		...
		static void SubmitQuadWithID(const glm::mat4& transform, const glm::vec4& texCoord, uint32_t textureID, uint32_t id, const glm::vec4& color = glm::vec4(1.0f), float tilingFactor = 1.0f);
