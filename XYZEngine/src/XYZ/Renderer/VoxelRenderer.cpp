...
#define TILE_SIZE 16
	...
	VoxelRenderer::VoxelRenderer()
		:
		m_ModelsOctree(AABB(glm::vec3(-512), glm::vec3(512)), 16)
	{
	...
	void VoxelRenderer::updateUniformBufferSet()
	{
		...
		Renderer::Submit([instance]() mutable {
			...
			auto uniformBuffer = instance->m_UniformBufferSet->Get(UBVoxelScene::Binding, UBVoxelScene::Set, currentFrame);	
			uniformBuffer->RT_Update(&instance->m_UBVoxelScene, sizeof(UBVoxelScene), 0);
		});
	}
