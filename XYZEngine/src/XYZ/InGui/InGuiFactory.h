...
namespace XYZ {
	...
	public:
		...
		static void GenerateTextHighlight(const char* text, InGuiWindow& window, const glm::vec2& position, const glm::vec2& size, const InGuiRenderData& renderData, uint32_t highlightCharIndex);
		static void GenerateQuadHighlight(InGuiWindow& window, const InGuiRenderData& renderData, uint32_t highlightQuadIndex);
	};
}