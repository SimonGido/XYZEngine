...
namespace XYZ {
	...
	public:
		...
		static std::pair<int32_t,int32_t> GenerateText(const glm::vec2& scale, const glm::vec4& color, const char* text, InGuiMesh& mesh, const InGuiRenderConfiguration& renderConfig);
